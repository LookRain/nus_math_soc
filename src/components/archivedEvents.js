...
/*	{
	...
	*/
	...
	},
	{
		...
		description : "<p>You may contact us at <a href='mailto:sudoku@nusmathsoc.org'>sudoku@nusmathsoc.org</a></p>",
						/*
						+
						"<p>Start a new paragraph like this</p>", // Can include any kind of html tags
						*/
		...
		poster : "images/posters/sudoku2016.jpg", //relative path
		portrait : true //whether the poster is portrait or not
	},
	{
		...
		date : "20 Feb 2016",
		timelineDate: "Feb",
		description: "<p>The Singapore Rubik’s Cube Competition is an annual competition held by the NUS Mathematics Society. \
						...
						the Open Category of the Competition would be a WCA-sanctioned (World Cube Association) event.</p>",
		website : "cube2016"
	},
	{
		...
		poster : "images/posters/cube2016.jpg", //relative path
	},
	
	{
		...
		startTime : "1900",
		endTime : "2100",
		poster : "images/posters/latex2016.jpg",
	...
	},
	{
		...
		startTime : "1800",
		endTime : "2100",
		poster : "images/posters/sharing2016.jpg",
		description : " <p>Our speakers will be sharing their experience and insights on several activities, \
						from the perspective of Pure Math, Applied Math and QF majors. </p>" +
						"<p>By discussing the details of these activities, we aim to assist students in these majors and related majors\
						in their academic and early career decisions.</p>"

	},
	{
		name : "Enrichment Talk 2015",
		id: "talk2015",
		venue : "LT31",
		venueDetails : "NUS Faculty of Science S16 Level 3",
		date : "29 Oct 2015",
		...
		startTime : "1830",
		endTime : "2030",
		poster : "images/posters/talk2015.jpg",
		registrationLink : "https://mysurvey.nus.edu.sg/EFM/se/54CCD14B444BCF08",
		portrait : true,
		description : " <b>Summary of the talk:</b>\
						<p>The topic of this year's talk is \"Wavelets in Imaging and Information Processing\",\
						It will illustrate some applications of mathematics and more specifically, \
						how the mathematical topic of wavelets is used in imaging and information processing.</p>" + 
						"<b>About our speaker:</b>\
						<p>Prof Goh Say Song who received his B.Sc (Hons) from the University of Oxford, \
						UK and his PhD. at the University of Michigan,USA. After lecturing in NUS for more than 20 years, \
						he has won several Teaching Excellence Awards for his engaging style of lecture and strong\
						enthusiasm for teaching mathematics.</p>"
	...
	},	
	{
		...
		startTime : "1830",
		endTime : "2130",
		website : "sudoku2015/index.html", //relative path, optional
		description : "<p>You may contact us at <a href='mailto:sudoku@nusmathsoc.org'>sudoku@nusmathsoc.org</a></p>", // Can include any kind of html tags
		registrationLink : "https://mysurvey.nus.edu.sg/EFM/se/54CCD14B3D76E181",
		registrationDetails : "No registration fees is required",
		refreshments : "Light refreshments will be provided before the prize presentation", //optional
		poster : "images/posters/sudoku2015.jpg", //relative path
		portrait : true //whether the poster is portrait or not
	},
	{
		name : "Singapore Rubik\'s Cube Competitions 2015 Open Cateogry",
		id: "cube2015open",
		venue : "LT31",
		venueDetails : "NUS Faculty of Science S16 Level 3",
		date : "14 ~ 15 Feb 2015",
		...
		startTime : "0830",
		endTime : "1900",
		website : "https://www.worldcubeassociation.org/results/c.php?i=SingaporeOpen2015"
	},
	{
		name : "Singapore Rubik\'s Cube Competitions 2015 School Cateogry",
		id: "cube2015school",
		venue : "LT31",
		venueDetails : "NUS Faculty of Science S16 Level 3",
		date : "7 Feb 2015",
		...
		startTime : "0900",
		endTime : "1700",
		registrationLink : "https://docs.google.com/forms/d/1e56sptlW5Z3oH1IK8QppmGV0rAsRlVIt3aWvtYUflRw/viewform",
		registrationDetails : "The deadline for registration is 4th Feb",
		description : "<p>The Singapore Rubik’s Cube Competition is an annual competition held by the NUS Mathematics Society. \
						It is the fifth year running in the history of the competition that there would be a total of three categories,\
						namely the NUS, School Category and the Open Category. </p>\
						<p>The school category is open to all the Primary Schools, \
						Secondary Schools and Junior Colleges (or equivilant) students</p>"
