  ...
  <section class="timeline-container timeline">
    <div @click="changeCurrentTimePoint(point)" v-for="point in points" class="timeline-block">
      ...
      <div class="timeline-content">
        ...
        <div class="column">
          <p v-if="point.date" class="date" v-text="point.date"></p>
        </div>
  ...
  export default{
    ...
    methods: {
      getImg: function (imgurl) {
        ...
        ImgObj.src = imgurl
        // 没有图片，则返回-1
        console.log('src is: ' + ImgObj.src)
        console.log('size is: ' + ImgObj.fileSize)
        console.log('width is: ' + ImgObj.width)
        console.log('height is: ' + ImgObj.height)
